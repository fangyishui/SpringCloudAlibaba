...
[1.理论入门](/doc/1.理论入门.md)

[2.boot和cloud版本选型](/doc/2.boot和cloud版本选型.md)

[3.cloud组件停更升级说明](/doc/3.cloud组件停更升级说明.md)

[4.微服务架构编码构建](/doc/4.微服务架构编码构建.md)

[5.Eureka服务注册与发现](/doc/5.Eureka服务注册与发现.md)
...
[9.OpenFeign服务接口调用](/doc/9.OpenFeign服务接口调用.md)

[10.Hystrix断路器](/doc/10.Hystrix断路器.md)

[11.zuul路由网关](/doc/11.zuul路由网关.md)
...
[RabbitMQ环境配置(Windows)](/doc/RabbitMQ环境配置(Windows).md)

[Windows安装并运行Nacos](/doc/Windows安装并运行Nacos.md)

[Windows上Seata-Server安装](/doc/Windows上Seata-Server安装.md)

[三个注册中心异同点](/doc/三个注册中心异同点.md)
